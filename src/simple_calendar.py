...
# source code: https://github.com/noXplode/aiogram_calendar
# needed to be localized and customized
class SimpleCalendar:
    ...
    async def start_calendar(
        ...
        inline_kb.row()
        inline_kb.insert(InlineKeyboardButton(
            "<< месяц", callback_data=calendar_callback.new("PREV-MONTH", year, month, day)
        ))
        inline_kb.insert(InlineKeyboardButton(" ", callback_data=ignore_callback))
        inline_kb.insert(InlineKeyboardButton(
            "месяц >>", callback_data=calendar_callback.new("NEXT-MONTH", year, month, day)
        ))
